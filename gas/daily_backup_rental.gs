// ============================================================
// Super Scaner - Daily Backup & Clear (GAS) — 株式会社レンタル経理部（社長専用）
// Deploy: SuperScaner_Internal/レンタル経理部/MF_Import_Data > 拡張機能 > Apps Script
...
const SOURCE_SS_ID = '1qhXto-sFZ4RsBI9O4a6Wg_9meOtdTU0BJWMMvLyRFgE';
const BACKUP_SS_ID = '1olvepE-a30BsEvIGwJf11sUimWSCVNElrvhnJoRKAzI';
